...
export default tool({
  description:
    "Search the web using Kagi's premium search engine. Provides high-quality, ad-free, privacy-respecting search results with rich snippets, news, and direct answers.",
